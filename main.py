        ...
        for i in range(count - 1, len(links)):
            ...
            if "visionias" in url:
                ...
                headers = {
                    ...
                    'x-access-token': f'eyJhbGciOiJIUzM4NCIsInR5cCI6IkpXVCJ9..hOI6QwpDfuBAZMmGIRIm7bYQVv3FUfoxg2nFb1by8Njjt7X5lt2_XnaBdbw_xtia',    
                    'accept-language': 'EN',
                    'api-version': '18',
